            ...
            <div className={classes.card}>
              ...
              <div className={classes.cardInner}>
                ...
                <p>
                  ...
                  starting React projects. I also dive into React hooks and the
                  use cases for most of the hooks.
                </p>
              </div>
            </div>
          </div>
          <div className="col">
            <div className={classes.card}>
              ...
              <div className={classes.cardInner}>
                ...
                <p>
                  In this blog i go through a detailed tutorial on how to start
                  a React app and all the little setup configurations you need
                  to do before starting to code. Also demonstrate the use of
                  some of the React hooks with in the application.
                </p>
              </div>
            </div>
          </div>
