      ...
      <div className={`container ${classes.outerDiv}`}>
        ...
        <div className={classes.resume}>
          <div className="row">
            <div className="col-8 offset-1">
              <p style={{ color: '#797979' }}>Request For Resume</p>
            </div>
            <div className="col-1">
              <a
                href="mailto: lancegee.apps@gmail.com?subject=Request For Resume"
                target="_blank"
                rel="noreferrer"
              >
                <svg
        ...
        <div className={classes.footer}>
          <div className="row ps-3">
            ...
            <div className="col-3 pt-2">
              <a href="tel: +14038915257" target="_blank" rel="noreferrer">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="20"
                  height="20"
